...
RUN cd /tmp && wget https://storage.cloud.google.com/sandbox-bucket-test/cms-upgrade_beaconhippo-14.5.0.1-SNAPSHOT-distribution.tar.gz?authuser=1 
RUN cd /opt/cms/tomcat/ && tar -xzf /tmp/cms-upgrade_beaconhippo-14.5.0.1-SNAPSHOT-distribution.tar.gz  webapps shared
